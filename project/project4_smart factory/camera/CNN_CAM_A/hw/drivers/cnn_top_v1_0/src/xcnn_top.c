...
void XCnn_top_Set_input_r(XCnn_top *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCnn_top_WriteReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_INPUT_R_DATA, (u32)(Data));
    XCnn_top_WriteReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_INPUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XCnn_top_Get_input_r(XCnn_top *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XCnn_top_ReadReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_INPUT_R_DATA + 4) << 32;
    return Data;
}
...
void XCnn_top_Set_weights(XCnn_top *InstancePtr, u64 Data) {
    ...
    XCnn_top_WriteReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_WEIGHTS_DATA, (u32)(Data));
    XCnn_top_WriteReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_WEIGHTS_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCnn_top_Get_weights(XCnn_top *InstancePtr) {
    ...
    Data = XCnn_top_ReadReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_WEIGHTS_DATA);
    Data += (u64)XCnn_top_ReadReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_WEIGHTS_DATA + 4) << 32;
    return Data;
}

u32 XCnn_top_Get_result(XCnn_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCnn_top_ReadReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_RESULT_DATA);
    return Data;
}

u32 XCnn_top_Get_result_vld(XCnn_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCnn_top_ReadReg(InstancePtr->Control_BaseAddress, XCNN_TOP_CONTROL_ADDR_RESULT_CTRL);
    return Data & 0x1;
}
